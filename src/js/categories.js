...
async function onClick(evt) {
    ...
    // backend request
    const resp = await axios.get(`${BASE_URL}/recipes?category=${evt.target.textContent}`)
    try {
...
function markupMenu(data) {
    return data.map(({preview, title, description, rating}) => `<li class="main-img-items">
